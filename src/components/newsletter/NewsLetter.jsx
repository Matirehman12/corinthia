        ...
        <>
            <div className="relative">
                <div className="grid  justify-center items-center">
                    <div className="md:me-32 mt-28">
                        <div className="header text-center mt-28 ">
                            <h1 className="text-3xl md:text-[64px] font-caslon bg-lightGray w-auto py-10 px-16 pt-16">{localization.treatment2.stayInTheLoop}</h1>
                        </div>
                        <div className="m-5">
                            <p className="mt-3 text-xl md:text-2xl font-caslon font-normal">{localization.treatment2.signUpToTheCorinthiaNewsletter}</p>
