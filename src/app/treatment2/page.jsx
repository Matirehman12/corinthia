    ...
    return (
        ...
        <>
            <div className="grid grid-cols-2">
                ...
                <div className="textContainer">
                    <div className="hrDiv flex">
                        <h1 className='text-5xl font-normal'>ANTI-WRINKLE <br /> INJECTIONS</h1>
                        <div class="border-l-2 border-gray-300  ml-20 h-[170px] z-50"></div>

                        <span className='mt-8 font-normal text-1xl ml-10'> At a glance </span>
                    </div>
                    <div className="textDiv bg-customGold mr-60 pt-10 pb-10">
                        <p className='text-1xl font-normal text-white mx-20  mb-5'>
                        ...
                        <p className='mx-20 mb-5 text-white text-1xl'>Treatment areas include :</p>
                        <ul className="list-disc list-inside mx-20 mb-5 text-white text-1xl">
                        ...
                        <p className="mt-4 text-1xl font-normal mx-20 mb-5 text-white">
            ...
            <div className="grid grid-cols-1 mt-20">
                <h1 className='d-flex items-center text-center text-4xl justify-center'>FAQs</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 h-[586px] bg-lightGray p-8 mr-60">
                ...
                <div className="bg-white p-8 flex flex-col max-w-lg h-[250px] mt-5   justify-start">
                    <div className="flex">
                        ...
                        <div className="flex flex-col">
                            <p className="text-lg italic mx-8 mb-4">
                            ...
                            <p className="text-lg font-semibold  text-right">Sarah</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2">
                <div className="leftRelated mt-20">
                    <h1 className='text-4xl text-center'>RELATED TREATMENTS</h1>
                ...
                <div className="rightRelated flex justify-center mt-20  flex-col ml-20">
                    <h1 className='text-4xl mb-20'>  RELATED <br /> CONDITIONS</h1>
                    <div className="list-one flex gap-20 ">
                        <p>Excessive sweating <Image src={arrowIcon} /></p>
                        <p>teeth grindling & <br /> Jaw Line Slimling<Image src={arrowIcon} /></p>
                    </div>
                    <div className="list-two flex gap-20 mt-5">
                        <p>Tired Eyes, Eyebags  <br /> & Dark Circles <Image src={arrowIcon} /></p>
                        <p>Thin Lips, Uneven  < br />  Lips&  Lip Lines <Image src={arrowIcon} /></p>
                    </div>
                    <div className="list-three mt-5 max-w-lg pb-20 border-b">
                        <p>Anti-Ageing <Image src={arrowIcon} /></p>
